...
namespace VirtoCommerce.Platform.Tests.Events
{
    public class EventBusTests
    {
        ...
        public async Task RegisterHandler_RegisterFakeHandler()
        {
            ...
            eventBus.RegisterHandler<ChangedIntegratrionEvent<IEntity>>((message, token) => changedHandler.Handle(message));
            ...
            //Act
            await eventBus.PublishAsync(new ChangedIntegratrionEvent<IEntity>(entity, (EventMetaInfoType.ModuleId, "SomeModuleId")));
    ...
    class FakeChangedEventHandler : IEventHandler<ChangedIntegratrionEvent<IEntity>>, IEventHandler<ChangedIntegratrionEvent<FakeEntity>>
    {
